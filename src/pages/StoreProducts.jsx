...
const StoreProducts = () => {
  ...
  const [showSyncFromStoreREsults, setShowSyncFromStoreResults] =
    useState(null);
        ...
        try {
          ...
          if (message !== "") {
            ...
            if (body.length === 0) {
              //empty
              setStatus(
                "Completed comparing store and central database, no differences found"
              );
            } else {
    ...
    return (
      <>
        {showResults && (
          <>
            <Heading level={5}>
              Results for new/removed products sync to DB
            </Heading>
            <Flex
              alignItems="center"
            ...
            >
              <CSVLink
                data={results}
                headers={resultColumns}
                filename={inputs.storename + "-import-results.csv"}
          ...
          <>
            ...
            >
              ...
              <CSVLink
                ...
                filename={inputs.storename + "-products.csv"}
                enclosingCharacter={``}
                className="amplify-button amplify-field-group__control"
              >
                {" "}
        ...
        {showChanges && (
          <>
            <Heading level={5}>
              Differences between store and main database
            </Heading>
            <Flex
              alignItems="center"
              alignContent="flex-start"
            ...
            >
              <CSVLink
                data={changes}
                headers={changeColumns}
                filename={inputs.storename + "-changes.csv"}
                className="amplify-button amplify-field-group__control"
              >
                {" "}
                Download as CSV
